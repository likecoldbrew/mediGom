    ...
    return (
        <div>
            <div className="z-20 mt-20 ml-96 max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md relative">
                ...
                <button
                    onClick={closeModal}
                    className="absolute top-0 right-2 mt-3 mr-3 mx-4  text-gray-500 hover:text-gray-700 focus:outline-none"
                >
                    X
                </button>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        <label htmlFor="certificateSearch" className="block text-sm font-medium text-gray-700 mb-1">담당 의사</label>
                        <input

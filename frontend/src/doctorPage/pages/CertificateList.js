            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                    <table className="w-full">
                        <thead>
                        <tr>
                            <th className="py-2 px-4 border-b-2 text-center">번호</th>
                            <th className="py-2 px-4 border-b-2 text-center">아이디</th>
                            <th className="py-2 px-4 border-b-2 text-center">이름</th>
                            <th className="py-2 px-4 border-b-2 text-center">발급 요청</th>
                        </tr>
                        </thead>
                        <tbody>
                        {users.map((user) => (
                            <tr key={user.userNo} className="hover:bg-blue-50">
                                <td className="py-2 px-4 border-b-2 text-center">{user.userNo}</td>
                                <td className="py-2 px-4 border-b-2 text-center">{user.userId}</td>
                                <td className="py-2 px-4 border-b-2 text-center">{user.userName}</td>

...
import { Person, Mail, Phone, Room, Today, EditCalendar, Work, EmojiEvents, ChromeReaderMode } from '@mui/icons-material';
        ...
        <Container maxWidth="xl" sx={{ py: 4 }}>
            ...
            <Card key={user.userNo} sx={{ mb: 6 }}>
                <CardHeader
                    ...
                    subheader={<Typography variant="h6">{user.admin == 2 ? '관리자' : null}</Typography>}
                />
                <CardContent>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
                {[
                    ...
                    { icon: <ChromeReaderMode />, title: '진료 목록', value: '8', subtitle: 'Team members' },
                    { icon: <ChromeReaderMode />, title: '처방 목록', value: '4/5', subtitle: 'Completed this quarter' },
                    { icon: <EmojiEvents />, title: '작성 글 목록', value: '7', subtitle: 'Earned this year' },
                    { icon: <EmojiEvents />, title: '서류 출력 기록', value: '7', subtitle: 'Earned this year' },
                    { icon: <EmojiEvents />, title: '입원 내역', value: '7', subtitle: 'Earned this year' },
                ].map((item, index) => (

...
const DoctorList = () => {
    ...
    useEffect(() => {
        ...
        if (statusFilter !== 'All Status') {
            result = result.filter(admin => admin.deleteYn.toLowerCase() === statusFilter.toLowerCase());
        }
                    ...
                    <table className="w-full">
                        ...
                        {filteredAdmins.map((admin) => (
                            <tr key={admin.userNo}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-center">{admin.userId}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-center">
                                  <span
                                      className={`px-2 inline-flex  text-xs leading-5 font-semibold rounded-full ${
                                          admin.deleteYn === 'N' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                      }`}
                                  >
                                    {admin.userName}
                                  </span>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-center">{admin.phone}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-center">{admin.email}</td>
                            </tr>
                        ))}
                        </tbody>
                    </table>

      ...
      >
          ...
          >
            ...
            <div className="flex items-center w-full">
              <input
                id="empId"
                name="empId"
                className="w-3/4 bg-[#eee] border-none py-[12px] px-[15px] my-2"
                type="text"
                placeholder="아이디"
              />
              <button
            ...
            <div className="flex items-center w-full">
              <input
                ...
                placeholder="전화번호"
              />
              <button className="rounded-[10px] w-1/4 border bg-sky-500 hover:bg-sky-600 text-white text-[12px] font-bold py-[12px] px-[20px] tracking-[1px] uppercase transition-transform duration-80 ease-in cursor-pointer focus:outline-none active:scale-95 ghost ghost:bg-transparent ghost:border-white ml-2">
                확인
              </button>
            </div>
            <div className="flex items-center w-full">
            ...
            <button className="rounded-[20px] border bg-sky-500 hover:bg-sky-600 text-white text-[12px] font-bold py-[12px] px-[45px] tracking-[1px] uppercase transition-transform duration-80 ease-in cursor-pointer focus:outline-none active:scale-95 ghost ghost:bg-transparent ghost:border-white mt-8">
              Sign Up
            </button>
          </form>
        </div>
        ...
        <div className="form-container sign-in-container">
          ...
          >
            ...
            <button className="rounded-[20px] border bg-sky-500 text-white hover:bg-sky-600  text-[12px] font-bold py-[12px] px-[45px] tracking-[1px] uppercase transition-transform duration-80 ease-in cursor-pointer focus:outline-none active:scale-95 ghost:bg-transparent ghost:border-white">
              Sign In
            </button>
          </form>
        </div>
